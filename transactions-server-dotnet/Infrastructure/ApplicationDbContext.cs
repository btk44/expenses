...
public class ApplicationDbContext : DbContext, IApplicationDbContext{
    ...
    public DbSet<AccountTransactionSum> AccountTransactionSums { get; set;} 
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) { 
        ...
        modelBuilder.Entity<AccountTransactionSum>().ToTable("AccountTransactionSum"); 
        ...
        modelBuilder.Entity<Account>().HasOne(x => x.AccountTransactionSum).WithOne(x => x.Account).HasForeignKey<AccountTransactionSum>(x => x.AccountId);
        modelBuilder.Entity<AccountTransactionSum>().HasKey(x => x.AccountId);
